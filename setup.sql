...
CREATE TABLE IF NOT EXISTS `skoj`.`users` (
  ...
  `status` INT NOT NULL COMMENT 'Da li je korisnik banovan, itd',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `skoj`.`submissions` (
  ...
  INDEX `fk_submissions_tasks1_idx` (`task_id` ASC),
...
-- -----------------------------------------------------
-- Table `skoj`.`testcases`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skoj`.`testcases` (
...
-- -----------------------------------------------------
-- Table `skoj`.`test_runs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skoj`.`test_runs` (
